...
public interface CustomerWalletRepository extends JpaRepository<CustomerWallet, Long> {
        ...
        @Query("""
                        ...
                        """)
        Optional<CustomerWalletSummaryResponseDto> findSummaryByUserId(Long userId);
        ...
        @Query("""
                        ...
                        and cw.isDelete=false
                        """)
        Optional<CustomerWallet> findByUserId(Long userId);
        ...
        @Query("""
                        ...
                        and cw.id = ?1
                        """)
        void blockWallet(Long walletId, LocalDateTime now);

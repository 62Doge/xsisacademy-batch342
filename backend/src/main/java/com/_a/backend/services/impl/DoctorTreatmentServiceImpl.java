...
>{
  ...
  public DoctorTreatmentResponseDTO save(DoctorTreatmentRequestDTO doctorTreatmentRequestDTO) {
    DoctorTreatment doctorTreatment = doctorTreatmentRepository.save(modelMapper.map(doctorTreatmentRequestDTO, DoctorTreatment.class));
    DoctorTreatmentResponseDTO doctorTreatmentResponseDTO = modelMapper.map(doctorTreatment, DoctorTreatmentResponseDTO.class);
    return doctorTreatmentResponseDTO;
  }

...
public class LocationController {
    ...
    public ResponseEntity<ApiResponse<PaginatedResponseDTO<LocationResponseDTO>>> getLocations(
        ...
        Page<LocationResponseDTO> locationResponseDTOS = locationService.findAll(pageNo, pageSize, sortBy,
                sortDirection);
    ...
    public ResponseEntity<?> getLocationByName(@PathVariable String name) {
        try {
            List<LocationResponseDTO> locationResponseDTOS = locationService.findByName(name);

            ApiResponse<List<LocationResponseDTO>> successResponse = new ApiResponse<>(HttpStatus.OK.value(),
                    HttpStatus.OK.getReasonPhrase(), locationResponseDTOS);
            return ResponseEntity.status(HttpStatus.OK).body(successResponse);
        } catch (Exception e) {
            ApiResponse<List<LocationResponseDTO>> errorResponse = new ApiResponse<>(

    ...
    public ResponseEntity<ApiResponse<PaginatedResponseDTO<LocationResponseDTO>>> getLocations(
        ...
        try {
            Page<LocationResponseDTO> locationResponseDTOS =
                        locationService.getAll(pageNo, pageSize, sortBy, sortDirection);
            PaginatedResponseDTO<LocationResponseDTO> paginatedResponse = new PaginatedResponseDTO<>(locationResponseDTOS);

            ApiResponse<PaginatedResponseDTO<LocationResponseDTO>> successResponse =
                    new ApiResponse<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), paginatedResponse);
            return ResponseEntity.status(HttpStatus.OK).body(successResponse);
        }catch (Exception e){
            ApiResponse<PaginatedResponseDTO<LocationResponseDTO>> errorResponse =
...
//                    new ApiResponse<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), locationResponseDTOS);
...
//    }
    ...
    public ResponseEntity<?> getLocationById(@PathVariable("id") Long id) {
        try {
            ...
            if (location.isPresent()) {
                ApiResponse<LocationResponseDTO> successResponse =
                        new ApiResponse<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), location.get());
                return ResponseEntity.status(HttpStatus.OK).body(successResponse);
            } else {
                ApiResponse<LocationResponseDTO> notFoundResponse =
                        new ApiResponse<>(HttpStatus.NOT_FOUND.value(), "Location  not found", null);
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body(notFoundResponse);
            }
        }catch (Exception e) {
            ApiResponse<LocationResponseDTO> errorResponse =
                    new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(), null);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
        }
    }
    ...
    public ResponseEntity<ApiResponse<PaginatedResponseDTO<LocationResponseDTO>>> getLocationByName(
        ...
        try {
            Page<LocationResponseDTO> locationResponseDTOS =
                    locationService.getByName(pageNo, pageSize, sortBy, sortDirection, name);
    ...
    public ResponseEntity<?> saveLocation(@Valid @RequestBody LocationRequestDTO locationRequestDTO) {
        ...
        try {
            ...
            ApiResponse<LocationResponseDTO> successResponse =
                    new ApiResponse<>(HttpStatus.OK.value(), HttpStatus.OK.getReasonPhrase(), locationResponseDTOSaved);
            return ResponseEntity.ok(successResponse);
        } catch (Exception e) {
            ApiResponse<LocationResponseDTO> errorResponse =
                    new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Failed to save Location ", null);
    ...
    public ResponseEntity<?> updateLocation(@Valid @RequestBody LocationRequestDTO locationRequestDTO, @PathVariable Long id) {
        try {
            ...
            ApiResponse<LocationResponseDTO> badRequestResponse =
            ...
            ApiResponse<LocationResponseDTO> errorResponse =
                    new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Failed to update Location ", null);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR.value()).body(errorResponse);
        }
    }
    ...
    public ResponseEntity<?> softDeleteLocation(@PathVariable Long id) {
        try {
            ...
            ApiResponse<LocationResponseDTO> successResponse =
                    new ApiResponse<>(HttpStatus.OK.value(), "Location  soft deleted", null);
            return ResponseEntity.ok(successResponse);
        }catch (IllegalArgumentException e) {
            ApiResponse<LocationResponseDTO> badRequestResponse =
                    new ApiResponse<>(HttpStatus.BAD_REQUEST.value(), e.getMessage(), null);
            ...
            ApiResponse<LocationResponseDTO> conflictResponse =
                    new ApiResponse<>(HttpStatus.CONFLICT.value(), e.getMessage(), null);
            return ResponseEntity.status(HttpStatus.CONFLICT).body(conflictResponse);
        } catch (Exception e) {
            ApiResponse<LocationResponseDTO> errorResponse =
                    new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Failed to soft delete Location ", null);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR.value()).body(errorResponse);
        }
    }
    ...
    public ResponseEntity<?> hardDeleteLocation(@PathVariable Long id) {
        try{
            ...
            ApiResponse<LocationResponseDTO> successResponse = new ApiResponse<>(HttpStatus.OK.value(), "Location  deleted", null);
            return ResponseEntity.ok(successResponse);
        } catch (Exception e) {
            ApiResponse<LocationResponseDTO> errorResponse = new ApiResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Failed to delete Location ", null);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR.value()).body(errorResponse);
        }
    }
